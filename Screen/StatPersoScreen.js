...
import {   Animated,  SafeAreaView, View, Text, StyleSheet,ScrollView, TouchableOpacity } from 'react-native';
      ...
      useEffect(() => {
       ...
       return (
        <View style={styles.ViewMain}>
          <Header titre={"Stats Perso"} navigation= {navigation} visible = {false} />
          ...
          {!isWinner ? (
                ...
                <View style={styles.EsperenceContainer}>
                    ...
                    <Text style={styles.textEsperence}>Espérence de vie : 
