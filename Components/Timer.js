...
const Timer = () => {
  ...
  const formatTime = (time) => {
    ...
    if (days === 0) {
        if(hours === 0){
            return `${formattedMinutes} m ${remainingSeconds} s`;
        }
        else{
