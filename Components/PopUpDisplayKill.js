    ...
    <Modal visible={props.visible} transparent onRequestClose={props.exit}>
      <TouchableOpacity style= {styles.View} onPress={props.exit} activeOpacity={1} >
        {props.isConfirmKill ? (
            ...
            <Text style={styles.sousTitre}>Ta cible a confirmé sa mort. Tu viens de recevoir une nouvelle cible et une nouvelle mission</Text>                                        
        </View>
        ) : (
            <View style={styles.Container} >
            <Text style={styles.Titre}>Dommage</Text>
            <Text style={styles.sousTitre}>Ta cible n'a pas confirmé sa mort. Tu n'as pas reçu de nouvelle cible</Text>
        </View>
        )
            }
