...
const SalonScreen = ({ navigation, route }) => {
  ...
  const isRefuseNewPlayer = useSelector(
    (state) => state.game.isRefuseNewPlayer,
  );
  ...
  const getGame = async () => {
    const responseCode = await createGame(
      userSurname,
      expoToken,
      setting,
      tagMission,
  ...
  return (
    <View style={styles.ViewMain}>
          ...
          {!gameIsStarted ? (
            ...
            <View style={styles.MainContainer}>
              <View style={styles.MessageContainer}>
                ...
                <Text style={styles.TextMessageDescription}>
                  L'hôte de la partie doit confirmer ton intégration
                </Text>
              </View>
      ...
      <PopUpConfirm
        message={
          hostFlag
            ? "Es-tu sûr de vouloir arrêter la partie ?"
