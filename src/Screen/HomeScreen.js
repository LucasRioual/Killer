    ...
    <View style={[styles.ViewMain, { backgroundColor: backColor }]}>
      ...
      <View style={styles.View3}>
        <MainMenu
          ...
          clickJoin={openPopUpJoin}
          color={MainColor}
          labelError={messageError}
          setMessageError={setMessageError}
          animRef={shakeAnimSurname}
      ...
      <View style={styles.View4}>
        <Footer
          clickRegle={openPopUpRegle}
          clickSettings={openPopUpSettings}
          color={MainColor}
          txtcolor={txtColor}
        />
      </View>
      ...
      <PopUpSettings
        visible={isPopUpSettingsVisible}
        exit={closePopUpSettings}
      />
      <PopUpJoin
        visible={isPopUpJoinVisible}
        exit={closePopUpJoin}
        setMessageError={setMessageError}
        animRef={shakeAnimSurname}
        shakeAnim={startShake}
