        ...
        {listMission.map((mission, index) => (
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor: props.selectedMissions.includes(
                  mission.mission,
                )
                  ? "#F0122D"
                  : "#D9D9D9",
          ...
          >
            <Text
              style={{
                color: props.selectedMissions.includes(mission.mission)
                  ? "white"
                  : "#927A7A",
              }}
            >
